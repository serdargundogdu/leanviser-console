...
Prod kalıcılık (ör. Cloud SQL). Faturayı JSONB olarak saklar:
invoices(id PK, data JSONB). Bağlantı işlem-başına açılır (düşük hacim; pool
sonraki optimizasyon). Serileştirme invoice_serialization'da ortaktır.
